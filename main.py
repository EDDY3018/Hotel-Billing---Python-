...
#===================Python Variables=======================
menu_category = ["Tea & Coffee","Beverages","Fast Food","Accra Ghana","Starters","Main Course","Dessert"]

menu_category_dict = {"Tea & Coffee":"1 Tea & Coffee.txt","Beverages":"2 Beverages.txt",
                "Fast Food":"3 Fast Food.txt","Accra Ghana":"4 Accra Ghana.txt",
...
def load_menu():
    ...
    for file in menu_file_list:
        ...
        #menu_tabel.insert('',END,values=["Edmund Quainoo","50"])
...
root.title("Welcome to Eddy Berk Hotel")
...
title_label = Label(title_frame, text="Eddy Berk Hotel", 
...
# order_tabel.insert('',END,text="HEllo",values=["Edmund Quainoo","50","2","100"])
###########################################################################################
